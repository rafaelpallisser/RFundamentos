...
# Array: possui 2 ou mais dimensões 1 um tipo de dado
...
# Maneiro mais fácil de explicar data frames: é uma metriz com diferentes tipos de dados
...
# Funções: também são vistas com objetos em R
