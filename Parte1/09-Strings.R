...
string1 <- c("Esta é a primeira parte da minha string e será a primeira parte do meu vertor",
...
# Podemos contas quantas vezes um caracter operece no texto
str_count(string2, "s")

# Localiza a primeira e última posição em que o caracter aparece
str_locate_all(string2, "s")

# Substitui a primeira ocorrência de uma caracter
